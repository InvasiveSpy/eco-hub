...
import InvasiveAnimalsBand from '../invasive-animals-band/InvasiveAnimalsBand';
...
export default function LandingPage() {
  ...
  return (
    <div className="video-bg">
      <div class="band"><h3 className="band-text">Click on a Species to learn more</h3> <InvasiveAnimalsBand onSpeciesClick={handleSpeciesClick} />
      </div>
